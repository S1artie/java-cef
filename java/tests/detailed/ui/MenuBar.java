...
public class MenuBar extends JMenuBar {
    ...
    public MenuBar(MainFrame owner, CefBrowser browser, ControlPanel control_pane,
        ...
        JMenuItem screenshotSync = new JMenuItem("Screenshot (on AWT thread)");
        screenshotSync.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                long start = System.nanoTime();
                CompletableFuture<BufferedImage> shot = browser.createScreenshot();
        ...
        JMenuItem screenshotAsync = new JMenuItem("Screenshot (from other thread)");
