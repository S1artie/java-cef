...
static int getModifiers(BOOLEAN forceShift) {
  ...
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, inputEventClassName), ALT_DOWN_MASK, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, inputEventClassName), CTRL_DOWN_MASK, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, inputEventClassName), SHIFT_DOWN_MASK, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, inputEventClassName), BUTTON1_DOWN_MASK, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, inputEventClassName), BUTTON2_DOWN_MASK, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, inputEventClassName), BUTTON3_DOWN_MASK, 0);
...
static int getMouseButton(WPARAM wParam) {
  ...
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, mouseEventClassName), BUTTON1, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, mouseEventClassName), BUTTON2, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, mouseEventClassName), BUTTON3, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, mouseEventClassName), NOBUTTON, 0);
...
static int getMouseEvent(WPARAM wParam) {
  ...
  const char * mouseEventClassName = "java/awt/event/MouseEvent";
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, mouseEventClassName), MOUSE_MOVED, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, mouseEventClassName), MOUSE_PRESSED, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, mouseEventClassName), MOUSE_RELEASED, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, mouseEventClassName), MOUSE_WHEEL, 0);
