...
int GetCursorId(cef_cursor_type_t type) {
  ...
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, cursorClassName), CROSSHAIR_CURSOR, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, cursorClassName), DEFAULT_CURSOR, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, cursorClassName), E_RESIZE_CURSOR, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, cursorClassName), HAND_CURSOR, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, cursorClassName), MOVE_CURSOR, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, cursorClassName), N_RESIZE_CURSOR, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, cursorClassName), NE_RESIZE_CURSOR, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, cursorClassName), NW_RESIZE_CURSOR, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, cursorClassName), S_RESIZE_CURSOR, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, cursorClassName), SE_RESIZE_CURSOR, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, cursorClassName), SW_RESIZE_CURSOR, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, cursorClassName), TEXT_CURSOR, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, cursorClassName), W_RESIZE_CURSOR, 0);
  JNI_STATIC_DEFINE_INT_RV(env, ScopedJNIClass(env, cursorClassName), WAIT_CURSOR, 0);
